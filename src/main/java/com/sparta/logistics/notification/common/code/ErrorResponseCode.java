...
public enum ErrorResponseCode implements ApiResponseCode {
    ...
    // Slack Message
    SLACK_MESSAGE_NOT_FOUND(HttpStatus.NOT_FOUND, "SLACK_0001", "해당하는 Slack 메세지를 찾을 수 없습니다."),

    // AI
    AI_GENERATION_FAILED(HttpStatus.BAD_GATEWAY, "AI_0001", "AI 메시지 생성에 실패했습니다.");
